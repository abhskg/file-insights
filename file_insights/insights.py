...
class Insights:
    ...
    def display(self):
        ...
        self.console.print(Panel.fit("📅 [bold]File Age Distribution[/bold]", style="yellow"))
...
class InsightGenerator:
    ...
    def _file_type_statistics(self) -> List[Dict]:
        ...
        for ext, files in sorted(files_by_ext.items(), key=lambda x: sum(f.size for f in x[1]), reverse=True):
